...
export const formData: FormData = {
  form: {
    id: 'yang108',
    name: {
      en: 'Yang Style Long Form (108 Postures)',
      sv: 'Yang-stil lång form (108 positioner)',
      zh_pinyin: 'Yáng Shì Tàijíquán Lǎojià',
      zh_hans: '杨式太极拳老架',
    },
    parts: [
      {
  ...
  milestones: [
    ...
    { label: 'P2', seq: 17 },
    { label: 'Cloud Hands', seq: 27 },
    { label: 'Kick Section', seq: 42 },
    { label: 'Snake Creeps', seq: 62 },
    { label: 'P3', seq: 74 },
    { label: 'Fair Lady', seq: 82 },
    { label: 'Snake Creeps', seq: 90 },
  ...
  postures: [
    {
      ...
      description: {
        en: 'Stand upright with feet shoulder-width apart, arms hanging relaxed, settling the body and calming the breath before the form begins.',
    ...
    },
    {
      seq: 2,
      names: {
        en: 'Opening of Tai Chi',
        sv: 'Tai Chi öppning',
        zh_pinyin: 'Tàijí Qǐshì',
        zh_hans: '太极起势',
      },
      description: {
        en: 'Raise both arms forward to shoulder height, then sink the elbows and press the palms down as the knees bend slightly.',
    ...
    },
    {
      ...
      description: {
        en: 'Sweep one hand across the forward knee to deflect low while the other palm pushes forward in a bow stance.',
    ...
    },
    {
      seq: 9,
      names: {
        en: 'Brush Knee and Twist Step (Repeat)',
    ...
    },
    {
      seq: 17,
      names: {
        en: 'Raise Hands and Step Up (Repeat)',
        sv: 'Lyft händerna och kliv fram (upprepning)',
        zh_pinyin: 'Tí Shǒu Shàng Shì',
        zh_hans: '提手上势',
      },
      description: {
    ...
    },
    {
      seq: 18,
      names: {
        en: 'White Crane Spreads Its Wings (Repeat)',
        sv: 'Vit trana sprider sina vingar (upprepning)',
        zh_pinyin: 'Bái Hè Liàng Chì',
        zh_hans: '白鹤亮翅',
      },
      description: {
    ...
    },
    {
      seq: 23,
      names: {
        en: 'Step Forward, Deflect, Parry and Punch (Repeat)',
        sv: 'Kliv fram, avled, parera och slå (upprepning)',
        zh_pinyin: 'Jìn Bù Bān Lán Chuí',
        zh_hans: '进步搬拦捶',
      },
      description: {
    ...
    },
    {
      seq: 24,
      names: {
        en: "Grasp the Bird's Tail (Repeat)",
        sv: 'Grip fågelns stjärt (upprepning)',
        zh_pinyin: 'Lǎn Què Wěi',
        zh_hans: '揽雀尾',
      },
      description: {
        en: 'Repeat ward-off, roll-back, press and push, cycling through the four primary energies.',
    ...
    },
    {
      seq: 25,
      names: {
        en: 'Single Whip (Repeat)',
        sv: 'Enkelt piskslag (upprepning)',
        zh_pinyin: 'Dān Biān',
        zh_hans: '单鞭',
      },
      description: {
        en: 'Hook the rear hand and push the front palm out, opening into a wide bow stance.',
    ...
    },
    {
      seq: 34,
      names: {
        en: 'Turn Body, Chop and Punch (Repeat)',
        sv: 'Vrid kroppen, hugg och slå (upprepning)',
        zh_pinyin: 'Piē Shēn Chuí',
        zh_hans: '撇身捶',
      },
      description: {
    ...
    },
    {
      seq: 38,
      names: {
        en: 'Turn and Kick with Left Heel (Repeat)',
        sv: 'Vrid och sparka med vänster häl (upprepning)',
        zh_pinyin: 'Zhuǎn Shēn Zuǒ Dēng Jiǎo',
        zh_hans: '转身左蹬脚',
      },
      description: {
    ...
    },
    {
      seq: 41,
      names: {
        en: 'Apparent Close-Up / Withdraw and Push (Repeat)',
        sv: 'Skenbar stängning / dra tillbaka och tryck (upprepning)',
        zh_pinyin: 'Rú Fēng Sì Bì',
        zh_hans: '如封似闭',
      },
      description: {
    ...
    },
    {
      seq: 42,
      names: {
        en: 'Cross Hands (Repeat)',
        sv: 'Korslagda händer (upprepning)',
        zh_pinyin: 'Shí Zì Shǒu',
        zh_hans: '十字手',
      },
      description: {
    ...
    },
    {
      seq: 43,
      names: {
        en: 'Embrace Tiger, Return to Mountain (Repeat)',
        sv: 'Omfamna tigern, återvänd till berget (upprepning)',
        zh_pinyin: 'Bào Hǔ Guī Shān',
        zh_hans: '抱虎归山',
      },
      description: {
    ...
    },
    {
      ...
      description: {
        en: 'Step diagonally and split the arms apart, the leading hand flaring up under the opponent’s arm like a horse’s mane.',
    ...
    },
    {
      seq: 51,
      names: {
        en: 'Cloud Hands (Repeat)',
        sv: 'Molnhänder (upprepning)',
        zh_pinyin: 'Yún Shǒu',
        zh_hans: '云手',
      },
      description: {
    ...
    },
    {
      seq: 56,
      names: {
        en: 'Step Back and Repulse the Monkey (Repeat)',
        sv: 'Kliv bakåt och driv bort apan (upprepning)',
        zh_pinyin: 'Dào Niǎn Hóu',
        zh_hans: '倒撵猴',
      },
      description: {
    ...
    },
    {
      seq: 57,
      names: {
        en: 'Slant Flying / Diagonal Flying (Repeat)',
        sv: 'Snedflygning (upprepning)',
        zh_pinyin: 'Xié Fēi Shì',
        zh_hans: '斜飞势',
      },
      description: {
    ...
    },
    {
      seq: 61,
      names: {
        en: 'Needle at Sea Bottom (Repeat)',
        sv: 'Nål på havets botten (upprepning)',
        zh_pinyin: 'Hǎi Dǐ Zhēn',
        zh_hans: '海底针',
      },
      description: {
    ...
    },
    {
      seq: 62,
      names: {
        en: 'Fan Through the Back (Repeat)',
        sv: 'Fläkt genom ryggen (upprepning)',
        zh_pinyin: 'Shàn Tōng Bèi',
        zh_hans: '扇通背',
      },
      description: {
    ...
    },
    {
      seq: 69,
      names: {
        en: 'High Pat on Horse (Repeat)',
        sv: 'Klappa hästen högt (upprepning)',
        zh_pinyin: 'Gāo Tàn Mǎ',
        zh_hans: '高探马',
      },
      description: {
    ...
    },
    {
      seq: 71,
      names: {
        en: 'Turn Body and Kick with Right Heel (Repeat)',
        sv: 'Vrid kroppen och sparka med höger häl (upprepning)',
        zh_pinyin: 'Zhuǎn Shēn Yòu Dēng Jiǎo',
        zh_hans: '转身右蹬脚',
      },
      description: {
    ...
    },
    {
      seq: 75,
      names: {
        en: 'Snake Creeps Down / Squatting Single Whip (Repeat)',
        sv: 'Ormen kryper ned / hukande piskslag (upprepning)',
        zh_pinyin: 'Dān Biān Xià Shì',
        zh_hans: '单鞭下势',
      },
      description: {
    ...
    },
    {
      ...
      description: {
        en: 'Deflect and parry, then step forward and deliver a fist strike.',
    ...
    },
    {
      seq: 84,
      names: {
        en: 'Fist Under Elbow (Repeat)',
        sv: 'Knytnäve under armbågen (upprepning)',
        zh_pinyin: 'Zhǒu Dǐ Chuí',
        zh_hans: '肘底捶',
      },
      description: {
    ...
    },
    {
      seq: 92,
      names: {
        en: 'Turn Body, White Snake Spits Out Tongue (Repeat)',
        sv: 'Vrid kroppen, vit orm spottar ut tungan (upprepning)',
        zh_pinyin: 'Zhuǎn Shēn Bái Shé Tǔ Xìn',
        zh_hans: '转身白蛇吐信',
      },
      description: {
    ...
    },
    {
      seq: 97,
      names: {
        en: 'Palm Thrust / Cross Hands and Thrust Palm (Repeat)',
        sv: 'Handflatestöt / korsa händer och stöt handflata (upprepning)',
        zh_pinyin: 'Chuān Zhǎng',
        zh_hans: '穿掌',
      },
      description: {
    ...
    },
    {
      seq: 99,
      names: {
        en: 'Step Forward to Seven Stars (Repeat)',
        sv: 'Kliv fram till de sju stjärnorna (upprepning)',
        zh_pinyin: 'Shàng Bù Qī Xīng',
        zh_hans: '上步七星',
      },
      description: {
        en: 'Rise from the low stance and cross both fists before the chest with the front foot on its toes.',
        sv: 'Res dig från den låga ställningen och korsa båda nävarna framför bröstet med den främre foten på tårna.',
      },
      tags: ['strike', 'stance', 'repetitive'],
      media: { image: null, audio: null, video: null, rig: null },
    ...
    },
    {
      seq: 100,
      names: {
        en: 'Step Back to Ride the Tiger (Repeat)',
        sv: 'Kliv bakåt och rid på tigern (upprepning)',
        zh_pinyin: 'Tuì Bù Kuà Hǔ',
        zh_hans: '退步跨虎',
      },
      description: {
        en: 'Step back and separate the hands, one rising overhead and one sinking low on an empty stance.',
    ...
    },
    {
      seq: 101,
      names: {
        en: 'Turn Body and Sweep Lotus (Repeat)',
        sv: 'Vrid kroppen och svep lotus (upprepning)',
        zh_pinyin: 'Zhuǎn Shēn Bǎi Lián',
        zh_hans: '转身摆莲',
      },
      description: {
    ...
    },
    {
      seq: 102,
      names: {
        en: 'Bend the Bow and Shoot the Tiger (Repeat)',
        sv: 'Spänn bågen och skjut tigern (upprepning)',
        zh_pinyin: 'Wān Gōng Shè Hǔ',
        zh_hans: '弯弓射虎',
      },
      description: {
    ...
    },
    {
      ...
      description: {
        en: 'Deflect and parry, then step in and deliver a final forward fist strike.',
    ...
    },
    {
      ...
      description: {
        en: 'Cycle a final time through ward-off, roll-back, press and push.',
    ...
    },
    {
      ...
      description: {
        en: 'Hook the rear hand and push the front palm outward into a final single whip.',
    ...
    },
    {
      ...
      description: {
        en: 'Turn and bring the arms crossed before the chest with even weight, settling toward the close.',
